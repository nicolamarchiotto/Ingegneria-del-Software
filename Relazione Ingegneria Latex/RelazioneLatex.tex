...
Abbiamo quindi preso la consegna e la abbiamo confrontata con i diagrammi da noi prodotti per verificare di aver centrato l'obiettivo del progetto.\\
In seguiti abbiamo passato il codice visivamente, per verificare di aver applicato i pattern nel modo corretto.\\
